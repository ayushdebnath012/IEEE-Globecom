...
\caption{Modality ablation. Text alone 0.934, image alone 0.664, fused 0.956, federated fused 0.956: federation costs nothing here, while dropping the text branch costs 29.1 points.}
\label{fig:ablation}
\end{figure}
